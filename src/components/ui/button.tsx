  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        // New modern variants
        gradient:
          "bg-gradient-to-r from-slate-700 to-blue-600 text-white shadow-lg hover:from-slate-600 hover:to-blue-500 hover:shadow-xl",
        outlineGlow:
          "border border-slate-500 text-slate-100 bg-transparent hover:bg-slate-800/60 shadow-sm hover:shadow-lg",
        glow:
          "bg-slate-800 text-white shadow-[0_8px_24px_rgba(37,99,235,0.25)] hover:shadow-[0_16px_36px_rgba(37,99,235,0.35)]",
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-10 rounded-md px-6 has-[>svg]:px-4",
        xl: "h-12 rounded-lg px-8 has-[>svg]:px-7 text-base",
        icon: "size-9",
      },
    },
    defaultVariants: {
