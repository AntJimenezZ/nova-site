/**
 * Marcas de las redes en SVG en línea.
 *
 * Ni lucide ni Phosphor traen la X actual ni un WhatsApp fiable: lucide solo
 * tiene el pájaro antiguo de Twitter. Tres paths pesan menos que una
 * dependencia de iconos de marca y quedan siempre correctos.
 *
 * Trazados: Simple Icons (CC0). Heredan currentColor, así que funcionan en
